            ...
            <div className="x_content">
              <div role="tabpanel">
                <ul className="nav nav-tabs bar_tabs" role="tablist">
                  ...
                  <li role="presentation" className=""><a href="#tab_roles" role="tab" data-toggle="tab" aria-expanded="true">Roles</a></li>
                  <li role="presentation" className=""><a href="#tab_symbols" role="tab" data-toggle="tab" aria-expanded="true">Symbols</a></li>
                </ul>
